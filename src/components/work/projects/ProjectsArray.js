...
export const ProjectsArray = [
         {
           ...
           image: rezipeImage,
           description:
             "Rezipe is a website that allows you to search for recipes based on name & calories. After being authenticated users can also add recipes into their dashboard. This app was created with Angular, Angularfire & Firebase. I worked with the edamam API in order to retrieve the recipes data. As for the styling I used SCSS.",
           website: "https://ng-rezipe-3f6c9.firebaseapp.com/",
         ...
         },
         {
           ...
           image: coronaImage,
           description:
             "Corona Pro is a website that informs you about the Coronavirus, how you should protect yourself and also some general information. This website was heavily focused on making the User Interface look beautiful but also being informative.",
         ...
         },
         {
           ...
           description:
             "Grand Burger is a restaurant. This personal project was for me to dig deeper into CSS & Flexbox. I created it with React.",
