...
const Contact = () => {
    ...
    return (
        ...
        <div className="contact__wrapper">
            ...
            <p className="contact__text">I am currently looking for a full-time position as a Front-End Developer. My inbox is always open, feel free to ask me anything, I'll try my best to answer your email!</p>
            <form
